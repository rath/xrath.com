        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <span className="text-xl font-bold gradient-text">Rath</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Link href="/about" className="text-sm text-foreground/70 hover:text-foreground hover:gradient-text transition-colors duration-300">
                About
              </Link>
              <Link href="/portfolio" className="text-sm text-foreground/70 hover:text-foreground hover:gradient-text transition-colors duration-300">
                Portfolio
              </Link>
